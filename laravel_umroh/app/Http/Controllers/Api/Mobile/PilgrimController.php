...
class PilgrimController extends Controller
{
    ...
    public function sos(SendSosRequest $request, SosService $sosService): JsonResponse
    {
        $pilgrim = $request->user()->pilgrim;
        $group = $this->activeJourney($request);
        $result = $sosService->create($pilgrim, $group, $request->validated());

        $report = $result['report']->load(['pilgrim.branch', 'pilgrim.latestLocation', 'group', 'handler']);
